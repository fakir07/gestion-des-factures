...
<div class="main-content app-content">
    ...
    <div class="container-fluid">
                                            ...
                                            <button aria-expanded="false" aria-haspopup="true"
                                                ...
                                                <a class="dropdown-item"  data-effect="effect-scale"
                                                 ...
                                                 <a class="dropdown-item"  data-effect="effect-scale"
                                                    data-id="{{$var_invoice->id}}"
                                                    data-invoice_number="{{$var_invoice->invoice_number}}" data-toggle="modal"
                                                    href="#restoer_invoice" title="delet">
        ...
        <!-- row closed -->
                         ...
                         <!--------------------------------------------------model restor-------------------------------------- -->
                         <!-- Modal -->
                         <div class="modal fade" id="restoer_invoice" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <form  action="{{route('archive_invoices.update','test')}}" method="POST">
                                    {{method_field('put')}} 
                                        {{csrf_field()}}
                                    {{-- fach kndiro ddelte bi model  mqkndirouch method delete {{method_field('delete')}} --}}
                                        ...
                                        <div class="modal-body">
                                            <div class="modal-body">                        
                                                <input type="hidden" name="invoice_id" id="invoice_id" value="">
                                                <p>Êtes-vous sûr du processus de restaurer invoices ? <strong class="varsup"></strong></p>                          <!--  <input class="form-control" name="section_name" id="section_name" type="text" readonly>-->
                                            </div>                        
                                        </div>
...
<script>
    $('#restoer_invoice').on('show.bs.modal', function(event) {
      var button = $(event.relatedTarget)
      var id_invoice = button.data('id')
      var invoice_number = button.data('invoice_number')
      var modal = $(this)
