                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('invoices.store')}}"  method="POST" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input class="form-control fc-datepicker" id="invoice_Date" name="invoice_Date" placeholder="yy-mm-dd"   required>
                                        {{-- <input class="form-control fc-datepicker" id="invoice_Date" name="invoice_Date" placeholder="dd-mm-yy"  value="{{ date('y-m-d') }}" required> --}}
                                    </div>
                                    <div class="col">
                                        <label  class="main-content-label tx-11 tx-medium tx-gray-600">Date d'échéance</label> 
                                       <input class="form-control fc-datepicker" id="Due_date" name="Due_date" placeholder="yy-mm-dd"  required>
                                    </div>
                                </div>
                                <!-- end Row 1 -->
                                 <br>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <select class="form-control" name="section" id="exampleFormControlSelect1">
                                            ...
                                            <option value="{{$var_sectione->id}}"> {{$var_sectione->section_nom}}</option>
                                            @endforeach
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="Amount_collection" name="Amount_collection"  required>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="Amount_Commission" name="Amount_Commission"  required>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <select  class="form-control SlectBox" name="Value_VAT"  id="Value_VAT" onchange="myFunction()">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" id="Rate_VAT" name="Rate_VAT" readonly>
                                  </div>
                                  <div class="col">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <input class="dropify"  type="file" name="aziz" accept=".jpg, .png, image/jpeg, image/png,pdf, html, zip, css,js" multiple>
